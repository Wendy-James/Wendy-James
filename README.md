# Wendy / 詹文婷 | AI Engineering · Backend · LLM Applications
...
|---|---|---|---|
| [外贸全品类获客助手 / AI B2B Outreach Workbench](https://github.com/Wendy-James/project-briefs/tree/main/case-studies/ai-b2b-outreach-workbench) | Private local workflow project, public architecture brief | Python, local web console, workflow scripts, automated safety tests | Campaign workflow, lead research and scoring, email dry-run, send safety gates, reply triage, anonymized supplier RFQ |
| [AI Job Search / Interview Assistant](https://github.com/Wendy-James/project-briefs/tree/main/case-studies/ai-career-interview-system) | Project experience, public code to be organized | LLM application workflow, JD parsing, resume generation, interview prep | JD parsing, resume tailoring, interview question flow, human review loop |
| [Document Intelligence Research](https://github.com/Wendy-James/project-briefs/tree/main/case-studies/adaptive-document-structuring-model) | Academic research, provincial project lead | Document structuring, requirement understanding, multi-scenario adaptation | Structured extraction thinking, scenario adaptation, evaluation and research documentation |
| [5G Network Slicing for Intelligent Transportation](https://github.com/Wendy-James/project-briefs/tree/main/case-studies/5g-network-slicing-its-optimization) | Academic / algorithm research | Network performance, optimization strategy, data / algorithm analysis | Performance modeling, resource allocation thinking, traffic scenario analysis |
...
Public brief: [project-briefs / AI B2B Outreach Workbench](https://github.com/Wendy-James/project-briefs/tree/main/case-studies/ai-b2b-outreach-workbench)
...
1. [Project Briefs](https://github.com/Wendy-James/project-briefs)
...
- Project briefs: [https://github.com/Wendy-James/project-briefs](https://github.com/Wendy-James/project-briefs)
